  ...
  return (
    ...
    <form onSubmit={handleSubmit} className="form">
      ...
      <label className="label">
        ...
        <input
          type="text"
          value={twethSchoolName}
          onChange={(e) => settwethSchoolName(e.target.value)}
          className="input"
        />
      </label>
      <label className="label">
      ...
      <label className="label">
        ...
        <input
          type="text"
          value={underGradClg}
          onChange={(e) => setunderGragClg(e.target.value)}
          className="input"
        />
      </label>
      <label className="label">
      ...
      <label className="label">
        ...
        <input
          type="file"
          multiple
          onChange={(e) => handleFileChange(e, setMemos)}
          className="input"
        />
      </label>
      <label className="label">
        ...
        <input
          type="file"
          onChange={(e) => handleFileChange(e, setSalary)}
          className="input"
        />
      </label>
      <label className="label">
        ...
        <input
          type="file"
          onChange={(e) => handleFileChange(e, setDigitalSignature)}
          className="input"
        />
      </label>
