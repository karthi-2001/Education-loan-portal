...
import ApplicationFormheading from "../../components/user/ApplicationFormheading";
  ...
  return (
    <>
      ...
      <div className="card" id="myCard2">
        <div className="container" id="myContainer2">
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="row">
                  ...
                  <div className=" mt-3 mb-4">
                    ...
                    <Link to={`/user/applicationformcontinue/${loanId}`}>
